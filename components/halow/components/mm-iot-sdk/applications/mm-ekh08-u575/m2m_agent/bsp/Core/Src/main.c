...
static void MX_LPTIM1_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(LPTIM1_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),15, 0));
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  GPIO_InitStruct.Pin = MMAGIC_DATALINK_IRQ_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(MMAGIC_DATALINK_IRQ_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(MMAGIC_DATALINK_WAKE_GPIO_Port, MMAGIC_DATALINK_WAKE_Pin, LL_GPIO_PULL_NO);
  ...
  /**/
  LL_GPIO_SetPinMode(MMAGIC_DATALINK_WAKE_GPIO_Port, MMAGIC_DATALINK_WAKE_Pin, LL_GPIO_MODE_INPUT);
