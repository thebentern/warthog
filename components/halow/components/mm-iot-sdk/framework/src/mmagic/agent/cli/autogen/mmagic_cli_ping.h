...
/**
 * Register the ping command bindings with the cli.
 *
 * @param cli Reference to the CLI instance.
 * @param mmagicd Reference to the mmagic_core data structure.
 */
void mmagic_cli_ping_register_bindings(EmbeddedCli *cli, struct mmagic_data *mmagicd);
...
/**
 * Initializes the CLI ping module.
 *
 * @param ctx       Reference to the global mmagic data structure.
 */
