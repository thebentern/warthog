...
/**
 * Register the ip command bindings with the cli.
 *
 * @param cli Reference to the CLI instance.
 * @param mmagicd Reference to the mmagic_core data structure.
 */
void mmagic_cli_ip_register_bindings(EmbeddedCli *cli, struct mmagic_data *mmagicd);
