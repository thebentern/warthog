...
/**
 * Register the wlan command bindings with the cli.
 *
 * @param cli Reference to the CLI instance.
 * @param mmagicd Reference to the mmagic_core data structure.
 */
void mmagic_cli_wlan_register_bindings(EmbeddedCli *cli, struct mmagic_data *mmagicd);
...
/**
 * Initializes the CLI wlan module.
 *
 * @param ctx       Reference to the global mmagic data structure.
 */
