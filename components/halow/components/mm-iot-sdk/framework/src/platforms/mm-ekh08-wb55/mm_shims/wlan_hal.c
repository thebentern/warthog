...
static void mmhal_wlan_spi_read_buf_dma(uint8_t *buf, unsigned len)
{
    ...
    while (LL_DMA_IsEnabledChannel(SPI_DMA_PERIPH, SPI_RX_DMA_CHANNEL))
    {}
    while (LL_DMA_IsEnabledChannel(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL))
    {}

    /* Configure DMA */
    LL_DMA_SetMemoryIncMode(SPI_DMA_PERIPH, SPI_RX_DMA_CHANNEL, LL_DMA_MEMORY_INCREMENT);
    LL_DMA_SetMemoryIncMode(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL, LL_DMA_MEMORY_NOINCREMENT);

    /* Configure Transaction */
    LL_DMA_ConfigAddresses(SPI_DMA_PERIPH, SPI_RX_DMA_CHANNEL, LL_SPI_DMA_GetRegAddr(SPI_PERIPH),
                           (uint32_t) buf,
                           LL_DMA_GetDataTransferDirection(SPI_DMA_PERIPH, SPI_RX_DMA_CHANNEL));
    LL_DMA_SetDataLength(SPI_DMA_PERIPH, SPI_RX_DMA_CHANNEL, (uint32_t) len);

    LL_DMA_ConfigAddresses(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL, (uint32_t) &spi_tx_data,
                           LL_SPI_DMA_GetRegAddr(SPI_PERIPH),
                           LL_DMA_GetDataTransferDirection(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL));
    LL_DMA_SetDataLength(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL, (uint32_t) len);
...
static void mmhal_wlan_spi_write_buf_dma(const uint8_t *buf, unsigned len)
{
    ...
    /* Configure DMA */
    LL_DMA_SetMemoryIncMode(SPI_DMA_PERIPH, SPI_RX_DMA_CHANNEL, LL_DMA_MEMORY_NOINCREMENT);
    LL_DMA_SetMemoryIncMode(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL, LL_DMA_MEMORY_INCREMENT);
    ...
    LL_DMA_ConfigAddresses(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL, (uint32_t) buf,
                           LL_SPI_DMA_GetRegAddr(SPI_PERIPH),
                           LL_DMA_GetDataTransferDirection(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL));
    LL_DMA_SetDataLength(SPI_DMA_PERIPH, SPI_TX_DMA_CHANNEL, (uint32_t) len);
...
/**
  * @brief This function handles SPI IRQ interrupt.
  */
