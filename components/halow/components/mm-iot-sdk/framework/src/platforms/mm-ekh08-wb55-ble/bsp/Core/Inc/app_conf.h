...
#define CFG_RTC_SYNCH_PRESCALER     (DIVR( LSI_VALUE, (CFG_RTC_ASYNCH_PRESCALER+1) ) - 1 )
...
/* Uncomment the below line to enable debug logging for BLE */
#define APP_DBG_MSG(...)        do{printf("[BLE] " __VA_ARGS__);}while(0);

/* We currently circumvent the logging functionality generated by ST as it is currently
 * incompatible with the MM-IoT-SDK. The infrastructure was left in to make viewing the
 * diff easier.*/
#ifndef APP_DBG_MSG
