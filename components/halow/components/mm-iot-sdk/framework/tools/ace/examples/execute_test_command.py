...
#
"""
Execute an opaque test command (as read from stdin).
"""
...
def _main():
    ...
    rsp = dutif.exec("wlan/execute_test_command", command=sys.stdin.buffer.read())
    sys.stdout.buffer.write(rsp.response)
