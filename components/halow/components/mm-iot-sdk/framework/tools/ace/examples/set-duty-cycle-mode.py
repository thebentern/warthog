...
#
"""
Emmet/Ace set duty cycle mode example
"""
...
def _main():
    ...
    group.add_argument("--spread", const="DUTY_CYCLE_MODE_SPREAD", action="store_const",
                       dest="mode", default="DUTY_CYCLE_MODE_SPREAD",
                       help="Duty cycle air time is evenly spread.")
    group.add_argument("--burst", action="store_const", dest="mode", const="DUTY_CYCLE_MODE_BURST",
                       help="Duty cycle air time available in burst.")
    ...
    dutif.exec("wlan/set_duty_cycle_mode", mode=args.mode)
    print(f"Duty cycle mode set to {args.mode}")
