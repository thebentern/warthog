...
#
"""
Emmet/Ace set AMPDU enabled example.
...
def _main():
    ...
    group.add_argument("--enable", "-e", action="store_true",
                       help="Enable AMPDU support")
    group.add_argument("--disable", "-d", action="store_true",
                       help="Disable AMPDU support")
    ...
    dutif.exec("wlan/set_ampdu_enabled", ampdu_enabled=args.enable)
    if args.enable:
        print("AMPDU support enabled")
    else:
        print("AMPDU support disabled")
