#!/usr/bin/env python3
"""
Emmet/Ace set dynamic power save timeout example
"""
#
...
def _main():
    ...
    parser.add_argument("timeout_ms",
                        help="Configures the timeout in milliseconds to set.")
    ...
    dutif.exec("wlan/set_dynamic_ps_timeout", timeout_ms=timeout_ms)
    print(f"Dynamic Power Save Timout set to {timeout_ms} ms")
