...
"""
Emmet/Ace set power save mode example.
...
def _main():
    ...
    if args.enable:
        print("Power save mode set to enabled")
        mode = "PWR_SAVE_ENABLED"
    elif args.disable:
        print("Power save mode set to disabled")
        mode = "PWR_SAVE_DISABLED"

    dutif.exec("wlan/set_power_save_mode", power_save_mode=mode)
