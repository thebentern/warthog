...
#
"""
Emmet/Ace set TX power override example.
...
def _main():
    ...
    parser.add_argument("tx_power", type=int,
                        help="The TX power override to set (0 to disable override)")
    ...
    dutif.exec("wlan/set_tx_power_override", tx_power_override=args.tx_power)
    print(f"TX power override set to {args.tx_power}")
