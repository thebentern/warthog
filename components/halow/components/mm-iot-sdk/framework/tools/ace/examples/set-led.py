...
#
"""
Emmet/Ace set LED example
"""
help_epilog = "Example arguments to turn on red LED (if available): LED_ID_RED LED_ON"
...
def _main():
    ...
    parser.add_argument("ledid",
                        help="LED ID to set: LED_ID_RED, LED_ID_GREEN, LED_ID_BLUE, LED_ID_WHITE")
    parser.add_argument("level",
                        help="Level to set: LED_ON, LED_OFF")
    ...
    dutif.exec("hal/set_led", led_id=args.ledid, level=args.level)
