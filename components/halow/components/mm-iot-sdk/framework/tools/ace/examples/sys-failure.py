...
#
"""
Emmet/Ace example that triggers various system failures.
"""
...
from acelib import ACE_ENUM, DutIf  # noqa: E402
...
def _main():
    ...
    parser.add_argument("failure_type", choices=ACE_ENUM.FailureType.choices(),
    ...
    dutif.exec("sys/trigger_failure", failure_type=args.failure_type)
