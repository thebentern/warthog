...
#
"""
Emmet/Ace set country code example
"""
...
def _main():
    ...
    parser.add_argument("countrycode",
                        help="Two letter country code to set")
    ...
    dutif.exec("wlan/set_country_code", country_code=args.countrycode)
    print(f"Country code set to {args.countrycode}")
